...
/*                n1.classList.remove("hidden");
            ...
            alert("Unfortunately the Burette reading you entered is not consistent with adding 10.00 mL’s of water to the flask.  Please empty the Burette and re-enter the mass of the empty flask to try again.");
