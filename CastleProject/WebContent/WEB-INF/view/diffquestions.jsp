	...
	<ul id="checks">
		...
		<li>	
			<ul>
				...
				<li><c:url value="/deentry.html" var="messageUrl" />
				<a href="deentry.html">Data Entry</a></li>				

				<li><c:url value="/text.html" var="messageUrl" />
				<a href="text.html">Text Area</a></li>				

				<li><c:url value="/compare.html" var="messageUrl" />
				<a href="compare.html">Comparision</a></li>				
