<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  ...
  <script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
        ...
        <style type="text/css">
            ...
            #questionsList {width: 100%; height:23em;  }
        
            div > ul, div > ul > li > ul { list-style-type: none; padding: 0.3em;}
...
#pdftabs a {
	...
	<body>
		<main>
			...
			<form action="AcidbaseUpdate" method="get">
                <ul id="excelId">
         ...
         <script src="<%=request.getContextPath()%>/resources/js/labJs3.js"></script>
