...
//	private AssignmentModuleDAO assignMod = null;
	...
	private StudentStatusDAO assignMod = null;
...
/*	public QuestionsDAO(InstructorQuestionsDAO insQuestions, StudentQuestionsDAO stuQuestions, AssignmentModuleDAO assignMod) {
	...
	@Autowired
	public void setAssignMod(StudentStatusDAO assignMod) {
		this.assignMod = assignMod;
		setExperimentsList();
	}

	private void setExperimentsList() {
		this.experimentsList = assignMod.getAllAssignmentDetails();
	}
	...
	private void setExperimentModules(int experimentId) {
		 experimentModules = assignMod.getModulesofExperiment(experimentId);
	}
